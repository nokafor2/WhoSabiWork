...
function displayTabbedPanelsContent($profileType) {
	...
	if ($profileType === 'user') {
		...
		$htmlOutput .= '<p>';
		$htmlOutput .= '<!-- Username -->';
		$htmlOutput .= '<input name="username" type="text" id="username" size="60" maxlength="50" placeholder="Username / Email / Phone number" autocomplete="off" autocorrect="off" autocapitalize="none" value="'.htmlentities($username).'"/>';
		$htmlOutput .= '<br />';
		$htmlOutput .= '<!-- Password -->';
		...
		$htmlOutput .= '<p>';
		$htmlOutput .= '<!-- Username -->';
		$htmlOutput .= '<input name="cusUsername" type="text" id="cusUsername" size="60" maxlength="50" placeholder="Username / Email / Phone number" autocomplete="off" autocorrect="off" autocapitalize="none" value="'.htmlentities($username).'"/>';
		$htmlOutput .= '<br />';
		$htmlOutput .= '<!-- Password -->';
