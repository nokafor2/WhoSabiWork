...
if (request_is_post() && request_is_same_domain()) {
	...
	if (isset($_FILES['photo'])) {
		...
		// No need for comment validation as special characters will be escaped before sent in the database.
		// Validate the caption entered using the validate comment fxn. 
		/*
