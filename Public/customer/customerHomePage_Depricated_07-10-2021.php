...
function setAvatarAndName() {
	...
	if ($avatarStatus === '../images/emptyImageIcon.png') {
		...
		$output .= '
			...
			<button id="setAptLinkBtn" class="btnStyle1" ><a class="setAptScrollLink scroll" href="#setAppointment" >Set Appointment</a></button>'.backLink().'
			<br/>';
...
function redirectPageTo($url) {
	...
	$_SESSION['redirectPage'] = 'customerHomePage.php?id='.$customerID;
		...
		<div id="setAppointment" class="setAppoitment">
			...
			<?php
				...
				?>
					...
					<p style="display: flex; justify-content: center;"><a class="btnStyle1" href="<?php echo redirectPageTo('../selectProfileType.php?page=signIn')?>">Please Sign In</a> <span style="margin-left:20px; margin-right: 20px;">OR</span> <a class="btnStyle1" href="selectProfileType.php?page=signUp">Please Sign Up</a></p>
				<?php
				}
			?>
		</div>
