...
if (request_is_get() || request_is_post()) {
	...
	function showAdvertiseBtn() {
		...
		if ($businessCategory->advertise) {
			$output .= '';
	    $output .= '<button id="advertise" class="btnStyle1" style="background-color: #A51300; color: #FFF">Advertising</button>';

    	/* $output .= '<span style="background-color: #A51300; color: #FFF; padding: 5px 10px; border-radius: 5px;">';
	      $output .= '<label>';
			    $output .= '<input name="Advertise" type="checkbox" value="advertise" id="male" />Advertising';
			  $output .= '</label>';
		  $output .= '</span>'; */
		} else {
			$output .= '<button id="advertise" class="btnStyle1" style="background-color: #A51300; color: #FFF">Advertise your business</button>';

			/* $output .= '<span style="background-color: #A51300; color: #FFF; padding: 5px 10px; border-radius: 5px;">';			        	
		    $output .= '<label>';
				    $output .= '<input name="Advertise" type="checkbox" value="advertise" id="male" /> Advertise your business';	
				$output .= '</label>';
			$output .= '</span>'; */
    }
...
<?php 
	/* 
		This file got depricated because the photo upload was upgraded from single photo upload at the gallery to multiple photo upload simultaneously.
	*/
?>