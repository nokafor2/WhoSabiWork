...
if (request_is_get() || request_is_post()) {
		...
		if ($vehicleType === "Cars") {
			if (!empty($allCarBrands)) {
				foreach($allCarBrands as $car => $value) {
					// name changed from car_brands[] to car_brands
			...
			if (!empty($allBusBrands)) {
				foreach($allBusBrands as $bus => $value) {
					// name changed from bus_brands[] to bus_brands
			...
			if (!empty($allTruckBrands)) {
				foreach($allTruckBrands as $truck => $value) {
					// name changed from truck_brands[] to truck_brands
	...
	function displayBussCateCheckBoxes($businessCategory) {
		...
		if ($businessCategory === "Artisan") {
			if (!empty($allArtisanServices)) {
				// name is changed from artisans[] to artisans
			...
			if (!empty($allSellerProducts)) {
				// name is changed from sellers[] to sellers
			...
			if (!empty($allTechServices)) {
				// name is changed from technical_services[] to technical_services
			...
			if (!empty($allSpareParts)) {
				// name is changed from spare_parts[] to spare_parts
	...
	function displayVehSpecializatn($vehicleType) {
		...
		// echo "Vehicle type is: ".$vehicleType."<br/>";
		
		$output = "";
		$output .= "<ul id='profileULStyle' class='profileULStyle'>";
		$output .= '<li class="profileLIStyle">';
		if ($vehicleType === "Cars") {
			if (!empty($carBrands)) {
	...
	function displayArtisansServParts($businessCategory) {
		...
		$output = "";
		$output .= "<ul id='profileULStyle1' class='profileULStyle'>";
		$output .= '<li class="profileLIStyle">';
		if ($businessCategory === "Artisan") {
			if (!empty($artisanServices)) {				
	...
	function selectDays() {
		...
		foreach ($weekDays as $key => $weekday) { 
		  if (!in_array($weekDates[$key], $editedSchedule)) {
			...
			$output .= '<option id="'.$weekDates[$key].'" value="'.$weekday.'">'.ucfirst($weekday).'  '.date_to_text($weekDates[$key]).'</option><br/>'; 
		  }
		}
		$output .= "</select>";
	...
	function displayCustomerAvailability() {
		...
		foreach ($editedSchedule as $key => $period) {
			...
			$output .= "<p id='customers_id' class='hideElement'>".$customerID."</p>";
			$output .= "<p id='date_available' class='hideElement'>".$editedSchedule[$key]."</p>";
			$output .= "<p class='weekday'>";
			$output .= date_to_weekday($editedSchedule[$key]);
			$output .= ":  ".date_to_text($editedSchedule[$key]);
			$output .= "</p>";

			// list all the time available
			$output .= "<div class'hoursDiv'>";
			...
			$output .= "<div class='checkBoxBtnDiv'>";
			// Show the edit button
			$output .= "<input type='button' value='Edit' id='openDiv".$key."' class='editButton btnStyle1' />";
			// Show the delete button
			// href='#' deleted from delete tag
			$output .= "<input type='button' data-cusavailid='".$customerAvailabilityId[$key]."' value='Delete' class='btnStyle1 deleteSchedule' id='deleteSchedule".$key."' onclick='deleteAvailSch(this.id);'/>";
			$output .= "</div>";

			$output .= "</div>";
			
			// Div for Editing schedule hours
			$output .= "<div class='editClass' id=".'editTime'.$key.">";
			$output .= '			
				<label>Edit Hours:</label>
				<br/>
				<div class="checkBoxBtnDiv">
					<label>
					<input type="checkbox" name="sltAllChkBox'.$key.'" value="sltAllChkBox'.$key.'" id="sltAllChkBox'.$key.'" onchange="sltAllChkBoxFxn(this)"/>Select All</label>
				</div>
				
				<div class="hoursDiv">
					<label class="hoursLabel">
					<input type="checkbox" name="edit_hours'.$key.'" value="eight_to_nine_am" id="eight_to_nine_am'.$key.'" />
					8:00 AM - 9:00 AM</label>
					
					<label class="hoursLabel">
					<input type="checkbox" name="edit_hours'.$key.'" value="nine_to_ten_am" id="nine_to_ten_am'.$key.'" />
					9:00 AM - 10:00 AM</label>
					
					<label class="hoursLabel">
					<input type="checkbox" name="edit_hours'.$key.'" value="ten_to_eleven_am" id="ten_to_eleven_am'.$key.'" />
					10:00 AM - 11:00 AM</label>
					
					<label class="hoursLabel">
					<input type="checkbox" name="edit_hours'.$key.'" value="eleven_to_twelve_pm" id="eleven_to_twelve_pm'.$key.'" />
					11:00 AM - 12:00 PM</label>
					
					<label class="hoursLabel">
					<input type="checkbox" name="edit_hours'.$key.'" value="twelve_to_one_pm" id="twelve_to_one_pm'.$key.'" />
					12:00 PM - 1:00 PM</label>
					
					<label class="hoursLabel">
					<input type="checkbox" name="edit_hours'.$key.'" value="one_to_two_pm" id="one_to_two_pm'.$key.'" />
					1:00 PM - 2:00 PM</label>
					
					<label class="hoursLabel">
					<input type="checkbox" name="edit_hours'.$key.'" value="two_to_three_pm" id="two_to_three_pm'.$key.'" />
					2:00 PM - 3:00 PM</label>
					
					<label class="hoursLabel">
					<input type="checkbox" name="edit_hours'.$key.'" value="three_to_four_pm" id="three_to_four_pm'.$key.'" />
					3:00 PM - 4:00 PM</label>

					<label class="hoursLabel">
					<input type="checkbox" name="edit_hours'.$key.'" value="four_to_five_pm" id="four_to_five_pm'.$key.'" />
					4:00 PM - 5:00 PM</label>

					<label class="hoursLabel">
					<input type="checkbox" name="edit_hours'.$key.'" value="five_to_six_pm" id="five_to_six_pm'.$key.'" />
					5:00 PM - 6:00 PM</label>

					<label class="hoursLabel">
					<input type="checkbox" name="edit_hours'.$key.'" value="six_to_seven_pm" id="six_to_seven_pm'.$key.'" />
					6:00 PM - 7:00 PM</label>

					<label class="hoursLabel">
					<input type="checkbox" name="edit_hours'.$key.'" value="seven_to_eight_pm" id="seven_to_eight_pm'.$key.'" />
					7:00 PM - 8:00 PM</label>

					<label class="hoursLabel">
					<input type="checkbox" name="edit_hours'.$key.'" value="eight_to_nine_pm" id="eight_to_nine_pm'.$key.'" />
					8:00 PM - 9:00 PM</label>

					<label class="hoursLabel">
					<input type="checkbox" name="edit_hours'.$key.'" value="nine_to_ten_pm" id="nine_to_ten_pm'.$key.'" />
					9:00 PM - 10:00 PM</label>
				</div>
				<br/>
				
				<div class="submitAndCloseBtnsDiv">
					<input type="button" value="Close" id="closeDiv'.$key.'" class="closeButton btnStyle1" />

					<input type="submit" name="submit_edited_availability'.$key.'" id="submit_new_availability'.$key.'" class="btnStyle1 submitEditSch" value="Submit" onclick="customer_availability_update(\'eight_to_nine_am'.$key.'\', \'nine_to_ten_am'.$key.'\', \'ten_to_eleven_am'.$key.'\', \'eleven_to_twelve_pm'.$key.'\', \'twelve_to_one_pm'.$key.'\', \'one_to_two_pm'.$key.'\', \'two_to_three_pm'.$key.'\', \'three_to_four_pm'.$key.'\', \'four_to_five_pm'.$key.'\', \'five_to_six_pm'.$key.'\', \'six_to_seven_pm'.$key.'\', \'seven_to_eight_pm'.$key.'\', \'eight_to_nine_pm'.$key.'\', \'nine_to_ten_pm'.$key.'\', \'sltAllChkBox'.$key.'\',  \'timeUL'.$key.'\', \'errorMessageDiv'.$key.'\' );" />
				</div>				
	...
	// Display advertise button
	function showAdvertiseBtn() {
		global $businessCategory;
		$output = "";

		if ($businessCategory->advertise) {
			$output .= '<input id="cancelAdInfo" type"text" value="Advertising" readonly />';
	    $output .= '<button id="cancelAdvertising" class="btnStyle1" >Cancel Advertising</button>';

	    $output .= '<button id="advertise" class="btnStyle1" style="display: none;">Advertise</button>';
		} else {
			$output .= '<input id="beginAdInfo" type"text" value="Advertise your business" readonly />';
			$output .= '<button id="advertise" class="btnStyle1" >Advertise</button>';

			$output .= '<button id="cancelAdvertising" class="btnStyle1" style="display: none;">Cancel Advertising</button>';
    }
        ...
        <div class="TabbedPanelsContentGroup">
          	...
          	<div class="CollapsiblePanelsDiv">
						  ...
						  <div id="CollapsiblePanel2" class="CollapsiblePanel">
							  ...
							  <div id="lastNamePanelContent" class="CollapsiblePanelContent">
								<form id="last_name_form" class="customer_label" name="last_name_form" method="post" action="" enctype="application/x-www-form-urlencoded">
								  <?php 
									echo $security->csrf_token_tag(); 
								  ?>
						  ...
						  <div id="CollapsiblePanel3" class="CollapsiblePanel">
							  ...
							  <div id="genderPanelContent" class="CollapsiblePanelContent">
								<form id="gender_form" class="customer_label" name="gender_form" method="post" action="" enctype="application/x-www-form-urlencoded">
								  <?php 
									echo $security->csrf_token_tag(); 
								  ?>
						  		<label>
	                  ...
	                  <button name="clear_gender" id="clear_gender" class="clearBtn btnStyle1" >Clear</button>
						  ...
						  <div id="CollapsiblePanel4" class="CollapsiblePanel">
							...
							<div id="usernamePanelContent" class="CollapsiblePanelContent">
								<form id="username_form" class="customer_label" name="username_form" action="" method="post" enctype="application/x-www-form-urlencoded">
								    <?php 
										echo $security->csrf_token_tag(); 
								    ?>
						  ...
						  <div id="CollapsiblePanel5" class="CollapsiblePanel">
							...
							<div id="passwordPanelContent" class="CollapsiblePanelContent">
							  <form id="password_form" class="customer_label" name="password_form" method="post" action="">
								  <?php 
									echo $security->csrf_token_tag(); 
								  ?>
						  ...
						  <div id="CollapsiblePanel6" class="CollapsiblePanel">
							...
							<div id="busNamePanelContent" class="CollapsiblePanelContent">
							  <form id="business_name_form" action="" method="post" enctype="application/x-www-form-urlencoded" name="business_name_form" class="customer_label">
							    <?php 
										echo $security->csrf_token_tag(); 
									?>
	    	          ...
	    	          <div id="busDescPanelContent" class="CollapsiblePanelContent">
	    	            <form method="post" action="" enctype="application/x-www-form-urlencoded" name="business_description_form" id="business_description_form">
	    	              ...
	    	              <label for="business_description">Edit business description</label> 
							  ...
							  <form id="business_email_form" action="" method="post" enctype="application/x-www-form-urlencoded" name="business_email_form" class="customer_label">
							    <?php 
										echo $security->csrf_token_tag(); 
									?>
						  ...
						  <div id="CollapsiblePanel9" class="CollapsiblePanel">
							...
							<div id="phoneNumPanelContent" class="CollapsiblePanelContent">
							  <form id="phone_number_form" action="" method="post" enctype="application/x-www-form-urlencoded" name="business_phone_number_form" class="customer_label">
							    <?php 
										echo $security->csrf_token_tag(); 
									?>
									...
									<?php
										if (isset($phone_validated) && !$phone_validated) { ?>
											<div id="verifyPhoneNumDiv" style="margin-top: 20px;">
												...
												<input name="verifyNumber" type="submit" id="verifyNumber" class="submitBtn btnStyle1" value="Verify phone number" /> 
											</div>
									<?php } ?>
									
									<div id="enterTokenDiv">
										<p> Enter the token received from your phone in the input field below. </p>
										<input style="float:none; margin-bottom: 5px;" name="smsToken" type="text" id="smsToken" class="inputText" size="60" maxlength="60" />
						  ...
						  <div id="CollapsiblePanel10" class="CollapsiblePanel">
							...
							<div id="addressLine1PanelContent" class="CollapsiblePanelContent">
							  <form id="address_line_1_form" action="" method="post" enctype="application/x-www-form-urlencoded" name="address_line_1_form" class="customer_label">
							    <?php 
										echo $security->csrf_token_tag(); 
									?>
						  ...
						  <div id="CollapsiblePanel11" class="CollapsiblePanel">
							...
							<div id="addressLine2PanelContent" class="CollapsiblePanelContent">
							  <form id="address_line_2_form" action="" method="post" enctype="application/x-www-form-urlencoded" name="address_line_2_form" class="customer_label">
							    <?php 
										echo $security->csrf_token_tag(); 
									?>
						  ...
						  <div id="CollapsiblePanel12" class="CollapsiblePanel">
							...
							<div id="addressLine3PanelContent" class="CollapsiblePanelContent">
							  <form id="address_line_3_form" action="" method="post" enctype="application/x-www-form-urlencoded" name="address_line_3_form" class="customer_label">
							    <?php 
										echo $security->csrf_token_tag(); 
									?>
						  ...
						  <div id="CollapsiblePanel13" class="CollapsiblePanel">
							...
							<div id="statePanelContent" class="CollapsiblePanelContent">
							  <form id="state_form" action="" method="post" enctype="application/x-www-form-urlencoded" name="state_form" class="customer_label">
							    <?php 
									echo $security->csrf_token_tag(); 
								?>
						  ...
						  <div id="CollapsiblePanel14" class="CollapsiblePanel">
							...
							<div class="CollapsiblePanelContent" id='townContent'>
							  <form id="town_form" action="" method="post" enctype="application/x-www-form-urlencoded" name="town_form" class="customer_label">
							    <?php 
										echo $security->csrf_token_tag(); 
									?>
						  ...
						  <div id="CollapsiblePanel15" class="CollapsiblePanel">
							...
							<div id="busCategoryPanelContent" class="CollapsiblePanelContent">
						  ...
						  <div id="CollapsiblePanel16" class="CollapsiblePanel">
								...
								<div id="vehCategoryPanelContent" class="CollapsiblePanelContent">
							...
							<div id="CollapsiblePanelContentTechServ" class="CollapsiblePanelContent">
							  <form action="" method="post" enctype="application/x-www-form-urlencoded" name="technical_services_form" id="technical_services_form">
							    <?php 
										echo $security->csrf_token_tag(); 
									?>
									<div id="displayBussCateCheckBoxes">
          ...
          <div class="TabbedPanelsContent">
            ...
            <div id="photoUpload">
                ...
                <div id="uploadPhotoEdit" >
                  ...
                  <div class="divContent">
	                  <input name="photosUpload" type="file" id="photosUpload" size="30" maxlength="30" accept="image/" class="fileUpload btnStyle1" multiple />
	                  <button type="button" class="fileUploadBtn btnStyle1"><i class="fas fa-image"></i>Choose Your Photos</button>
	                  <span class="fileUploadLabel" style="display: none;"></span>
                    <p id="imgTypeLabel">Allowed images: .jpg, .jpeg, .png, .gif</p>
                    <p id="imgTypeLabel">You can upload a maxiumum of 20 pictures at a time.</p>        
	                  ...
	                  <button id="cancelUploadImgs" name="cancelUploadImgs" class="submitBtn btnStyle1">Cancel</button>
	                  <br>
	                  <progress id="imageProgressBar" class="progress" value="0" max="100" ></progress>
	                  <div id="previewDiv" class="display_img" >
                    </div>
          ...
          <div class="TabbedPanelsContent" >
			        ...
			        <form id="form2" name="form2" method="post" action="" >
						...
						<div id="displayAppointments" class="displayAppointments">
							<h3 id="aptDivHeading" class="divHeading"> List of your created schedules for a week </h3>
